...
namespace SearchAThing
{
    ...
    public class GridSplitterManager : UserControl
    {
        ...
        public Func<Control> CreateControl
        {
            ...
            set
            {
                if (_CreateControl != null) throw new Exception($"cannot initialize twice");
                SetAndRaise(CreateControlProperty, ref _CreateControl, value);
                if (value != null) CreateInitialControl();
            }
        }
        #endregion       
        ...
        public void PrintStructure(TextWriter wr = null, Control highLightControl = null, bool breakOnWarn = false)
        {
            ...
            CustomScanGrid((x) =>
            {
                ...
                var highStr = "";
                if (highLightControl != null && ctl is Border && (ctl as Border).Child == highLightControl) highStr = " <===";
        ...
        void Adjust()
        {
            ...
            {
                if (gr.Parent == null) continue; // during this process an existing leaf can removed
